...
class TestReturnFixer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fixer = ReturnOutsideFunctionFixer(create_backups=False)  # No backups for tests
...
'''
        ...
        self.assertIn('# TODO: Fix orphaned return statement: return "orphaned"', fixed_content)
