    ...
    def validate_syntax(self, file_path):
        ...
        try:
            ...
            if "\\n" in source and "from typing import" in source:
                self.log_issue("warning", str(file_path), "Contains escaped newlines near typing imports")
                return False
        ...
        try:
            ...
            if uses_types:
                ...
                if not has_typing_import:
                    self.log_issue("error", str(file_path), "Uses type annotations but missing 'from typing import'")
                    return False
                else:
        ...
        if fix_script.exists():
            ...
            if self.validate_syntax(fix_script):
                ...
                if 'try:' in content and 'except' in content:
                    ...
                    self.log_issue("warning", "emergency_workflow_fix.py", "Limited error handling")
        else:
