...
core = lazy_import("qemlflow.core")
research = lazy_import("qemlflow.research")
integrations = lazy_import("qemlflow.integrations")

# Lazy-loaded specific modules
#_featurizers = lazy_import("qemlflow.core.featurizers")
#_models = lazy_import("qemlflow.core.models")
#_utils = lazy_import("qemlflow.core.utils")
